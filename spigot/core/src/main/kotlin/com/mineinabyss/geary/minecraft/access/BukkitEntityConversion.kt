...
public fun geary(entity: Entity): GearyEntity =
    BukkitAssociations.getOrNull(entity.uniqueId) ?: BukkitEntityAssociations.registerEntity(entity)
...
public fun gearyOrNull(entity: Entity): GearyEntity? = BukkitAssociations.getOrNull(entity.uniqueId)
