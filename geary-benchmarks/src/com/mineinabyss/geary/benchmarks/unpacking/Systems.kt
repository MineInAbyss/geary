...
fun Geary.systemOf3() = cache(query<Comp1, Comp2, Comp3>())
fun Geary.systemOf4() = cache(query<Comp1, Comp2, Comp3, Comp4>())
fun Geary.systemOf5() = cache(query<Comp1, Comp2, Comp3, Comp4, Comp5>())
